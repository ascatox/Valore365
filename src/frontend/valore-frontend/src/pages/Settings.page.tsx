          ...
          >
            <Stack gap="lg">
              ...
              <TextInput
                ...
                description={copilotProvider === 'openai' ? 'Default: gpt-4o-mini' : copilotProvider === 'anthropic' ? 'Default: claude-sonnet-4-20250514' : copilotProvider === 'gemini' ? 'Default: gemini-2.0-flash' : copilotProvider === 'openrouter' ? 'Default: mistralai/mistral-small-3.2-24b-instruct' : ''}
                style={{ maxWidth: 400 }}
              />
