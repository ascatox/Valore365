      ...
      <Stack gap="xl">
        ...
        <Card withBorder radius="xl" padding="xl">
          <Stack gap="md">
            ...
            <Text c="dimmed">
              ...
              L'obiettivo è avere una vista leggibile del portafoglio, dei rischi principali e del percorso verso i target personali.
            </Text>
          </Stack>
        </Card>
        ...
        <SimpleGrid cols={{ base: 1, md: 2 }} spacing="lg">
          <InfoCard
            icon={IconBriefcase}
            title="Portfolio"
            description="Gestione portafogli, posizioni, transazioni, liquidità e riepiloghi operativi in un unico flusso."
          />
          <InfoCard
          ...
          <InfoCard
            icon={IconRobot}
            title="Copilot"
            description="Supporto conversazionale per leggere più rapidamente i dati del portafoglio e individuare spunti di analisi."
          />
          <InfoCard
            icon={IconShieldCheck}
            title="Controllo e privacy"
            description="Modalità privacy, impostazioni utente dedicate e separazione tra configurazione locale e servizi backend."
          />
        </SimpleGrid>

        <Card withBorder radius="xl" padding="xl">
          <Stack gap="sm">
            <Title order={4}>Per chi è pensata</Title>
            <Text c="dimmed">
              Per investitori che vogliono seguire il proprio patrimonio con più dettaglio operativo rispetto a un semplice tracker,
              senza perdere leggibilità su mobile e senza disperdere le informazioni tra strumenti separati.
            </Text>
          </Stack>
        </Card>
        ...
        <Card withBorder radius="xl" padding="xl">
          <Stack gap="sm">
            ...
            <Text c="dimmed">
              Valore365 è curato da <Text span fw={700} c="inherit">Antonio Scatoloni</Text>.
            </Text>
